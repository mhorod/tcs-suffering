...
\begin{proof}
	...
	Niech \(\left( \left( X_t,Y_t \right)  \right) _{t \in  \N}\) będzie sprzęganiem łańcuchów o macierzy przejścia \(P^{r}\) zadanym w następujący sposób: dla (\(X_t, Y_t \)) = (\(x_1, x_2\)) zakładamy, że jeżeli łańcuchy się zeszły, to już się nie rozchodzą (czyli jeżeli \(X_t\) oraz \(Y_t\) są równe, to \(X_{t+1}\) i \(Y_{t+1}\) również będą równe).
