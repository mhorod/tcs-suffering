%<*probabil-egzamin-approximation-of-harmonic>
%<*probabil-2025-10-10-aproksymacja-szeregu-harmonicznego>
\begin{lemma} \label{approximation-of-harmonic} \(H_n = \ln(n) + \Theta(1)\)\\
	\begin{tikzpicture}
...
%<*probabil-egzamin-kolekcjoner-kuponow>
...
\]
Ostatnia równość wynika z \ref{approximation-of-harmonic}.
%</probabil-2025-10-10-problem-kolekcjonera-kuponow>
%</probabil-egzamin-kolekcjoner-kuponow>
...
%<*probabil-egzamin-quicksort>
%<*probabil-2025-10-10-oczekiwany-czas-quicksorta>
\subsection{Oczekiwana liczba porównań Quicksorta}
...
\begin{proof} Niech \( x_1, \dots, x_n \) będzie wejściowym ciągiem \( n \) różnych liczb.
	...
	\end{align*}
	Teraz korzystamy z \ref{approximation-of-harmonic} i dostajemy
	\begin{align*}
		\expected{X}
