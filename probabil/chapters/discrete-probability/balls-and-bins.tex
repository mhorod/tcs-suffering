...
\end{theorem}
\begin{proof}
	Nie ma co się zrażać mnogością logarytmów; sam w sobie dowód jest względnie prosty -- stosujemy dwa razy \textit{union-bound}, a ograniczenie z tezy po prostu pałujemy naszymi lematami, na egzaminie raczej nie będziecie potrzebowali obliczeń.
	...
	\]
	Korzystamy teraz z obu lematów i ograniczamy prawdopodobieństwo na to, że istnieje urna w której jest co najmniej \( M \) kul przez co najwyżej
	\[
		n\pars{\frac{e}{M}}^M
	\]
