...
%<*probabil-egzamin-chernoff-lowerbound>
...
\end{theorem}
\begin{proof}
	Dowód identyczny jak w \ref{poisson-trial-chernoff-bounds}, wybieramy \(t = \ln \pars{ 1-\delta } < 0\) i korzystamy z tego, że \(e^{-z}\) jest antymonotoniczne. Drugiego punktu ponownie dowodzimy licząc pochodne i na ich podstawie dowodząc odpowiedniej nierówności.
\end{proof}
%</probabil-2025-11-14-poisson-trial-chernoff-bound-2>
%</probabil-egzamin-chernoff-lowerbound>
