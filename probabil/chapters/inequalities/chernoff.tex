...
\begin{proof}
    Zaczniemy od punktu \(1\), a pozostałe wynikną z niego.
    \begin{align*}
        \prob \pars{X \ge (1+\delta)\mu} &= \prob \pars{e^{tX} \ge e^{t(1+\delta)\mu}}  \\
        &\le \frac{\expected {e^{tX}}}{e^{t(1+\delta)\mu}}                              \\
        &\le \frac{{e^{(e^t-1)\mu}}}{e^{t(1+\delta)\mu}}
    \end{align*}
    Podstawiamy tutaj \(t = \ln{(1+\delta)}\)
    \begin{align*}
        \frac{{e^{(e^t-1)\mu}}}{e^{t(1+\delta)\mu}} &= \frac{e^{\delta\mu}}{e^{(1+\delta)\mu\ln{1+\delta}}} \\
        &= \frac{e^{\delta\mu}}{{(1+\delta)}^{(1+\delta)^\mu}}                                              \\
        &= \pars{\frac{e^\delta}{(1+\delta)^{1+\delta}}}^\mu
    \end{align*}
\end{proof}

\begin{proof}
    Do drugiego punktu pokażemy, że \(\frac{e^\delta}{\pars{1+\delta}^{1+\delta}} \le e^{\frac{-\delta^2}{3}}\) dla \(\delta \in \pars{0, 1}\).
...
\begin{theorem}
	Niech \(X_1,\ldots,X_n\) będą niezależnymi zmiennymi takimi, że \(P \pars{ X_i=1 } = p_i\) oraz \(P \pars{ X_i = 0 } = 1-p_i\). Niech \(X = \sum_{i=1}^{n} X_i\) oraz \(\mu = \mathbb{E}\left[ X \right] \). Wtedy:
	\begin{enumerate}
		\item \(\forall_{\delta > 0} \ P \pars{ X \ge \pars{ 1+\delta } \mu } \le \pars{ \frac{e^{\delta}}{ \pars{ 1+\delta } ^{1+\delta}} } ^{\mu} \)
		\item \(\forall_{\delta \in (0,1]} \ P \pars{ X \ge \pars{ 1+\delta } \mu } \le e^{-\frac{\mu\delta^2}{3}} \)
		\item \(\forall_{R \ge 6\mu} \ P \pars{ X \ge R } \le 2^{-R} \).
	\end{enumerate}
\end{theorem}
\begin{proof}
	...
	\[P \pars{ X \ge \pars{ 1+\delta } \mu } \le \pars{ \frac{e^{\delta}}{ \pars{ 1+\delta } ^{1+\delta}} } ^{\mu} \le \pars{ \frac{e}{1+\delta} } ^{ \pars{ 1+\delta } \mu} \le \pars{ \frac{1}{2} } ^{R} = 2 ^{-R}.\]
\end{proof}
