...
\begin{definition} Niezależność procesów Poissona.

	Niech \(N_1\), \(N_2\) - procesy Poisonna. Mówimy, że są one niezależne, jeśli \(\forall_{x, y} N_1(x)\) i \(N_2(y)\) są niezależne. 
