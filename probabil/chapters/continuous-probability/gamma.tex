...
\begin{definition}
    Mówimy, że ciągła zmienna losowa ma \textbf{rozkład Gamma} z parametrem \( \pars{a, \lambda} \), jeżeli jej funkcja gęstości jest równa:
    \[
...
\begin{proof}
    Niech \( X \) ma rozkład Gamma z parametrem \( (a, 1) \). Niech \( Y = \frac{X}{\lambda} \). Wtedy mówimy, że \( Y \) ma rozkład Gamma z parametrem \( (a, \lambda) \). 
    Chcemy pokazać, że to poprawny rozkład. Możemy to sobie oczywiście przecałkować i zobaczyć, że faktycznie wyjdzie \( 1 \) ale można też skorzystać z takiego przekształcenia:
    \[
...
\begin{fact}
    Dla \( Y \sim \) Gamma(\(a, \lambda\)) (Czyli \(Y = \frac{X}{\lambda} \), dla \( X \sim \) Gamma(\(a, 1\))):
    \[
