...
%<*probabil-egzamin-16-rozklad-wykladniczy-1>
\begin{definition}
...
%<*probabil-egzamin-16-rozklad-wykladniczy-2>
\begin{theorem}[MGF]
...
\begin{proof}
	...
	\allowdisplaybreaks
	\begin{align*}
		\mathrm{P}(X_1 \leq X_2) &= \int_{x_2 = -\infty}^{\infty} \int_{x_1 = -\infty}^{x_2} f_{X_{1}X_{2}}(x_1, x_2) \; \diff x_{1} \diff x_{2} & \\
		&= \int_{x_2 = -\infty}^{\infty} f_{X_{2}}(x_2) \int_{x_1 = -\infty}^{x_2} f_{X_1}(x_1) \; \diff x_{1} \diff x_{2} \\
		&= \int_{x_2 = 0}^{\infty} \lambda_2 e^{-\lambda_{2}x_2} \int_{x_1 = 0}^{x_2} \lambda_1 e^{-\lambda_1 x_1} \; \diff x_{1} \diff x_{2} \\
		&= \lambda_1 \lambda_2 \int_{x_2 = 0}^{\infty} e^{-\lambda_{2}x_2} \int_{x_1 = 0}^{x_2} e^{-\lambda_1 x_1} \; \diff x_{1} \diff x_{2} \\
		&= \lambda_1 \lambda_2 \int_{x_2 = 0}^{\infty} e^{-\lambda_{2}x_2} \brackets{\frac{-e^{-\lambda_1 x_1}}{\lambda_1} }_{0}^{x_2} \; \diff x_{2} \\
		&= \lambda_1 \lambda_2 \int_{x_2 = 0}^{\infty} e^{-\lambda_{2}x_2} \pars{\frac{-1}{\lambda_1} e^{-\lambda_1 x_2} - \frac{-1}{\lambda_1} e^0} \; \diff x_2 \\
		&= \lambda_1 \lambda_2 \int_{x_2 = 0}^{\infty} e^{-\lambda_2 x_2} \frac{-1}{\lambda_1} \pars{e^{-\lambda_1 x_2} - 1} \; \diff x_2 \\
		&= -\lambda_2 \int_{x_2=0}^{\infty} e^{-\lambda_2 x_2} \pars{e^{-\lambda_1 x_2} - 1} \; \diff x_2 \\
		&= -\lambda_2 \int_{x_2=0}^{\infty} e^{-x_2\pars{\lambda_2 + \lambda_1}} - e^{-\lambda_2 x_2} \; \diff x_2 \\
		&= -\lambda_2 \pars{\int_{x_2=0}^{\infty} e^{-x_2\pars{\lambda_2 + \lambda_1}} \; \diff x_2 - \int_{x_2=0}^{\infty} e^{-\lambda_2 x_2} \; \diff x_2} \\
		&= -\lambda_2 \pars{\brackets{\frac{-1}{\lambda_1 + \lambda_2} e^{-x_2(\lambda_1 + \lambda_2)}}_{0}^{\infty} - \brackets{\frac{-1}{\lambda_2} e^{-\lambda_2 x_2}}_{0}^{\infty}} \\
...
%<*probabil-egzamin-17-kule-urny-feedback>
%<*probabil-2025-12-05-kule-i-urny-z-feedbackiem>
