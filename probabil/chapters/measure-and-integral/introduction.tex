Na początek skupmy się na prostym problemie: mamy \(\Omega\) - uniwersum, oraz \(A \subseteq \Omega\). Losujemy jednostajnie element \(x \in \Omega\) i chcemy poznać \(\prob(x \in A)\).
