...
\]
Gdzie \( q_n \) jest jakimś ciągiem liczb wymiernych. Z połączenia tego faktu i założenia o ciągłości funkcji \(h\) otrzymamy:
\[
...
\]
z czego dostajemy już kompletny wzór na gęstość.

%<*licencjat-standardowy-rozklad-normalny-1>
\begin{theorem}
	Standardowym rozkładem normalnym nazywamy rozkład zadany gęstością
...
%<*licencjat-standardowy-rozklad-normalny-2>
\begin{theorem}
