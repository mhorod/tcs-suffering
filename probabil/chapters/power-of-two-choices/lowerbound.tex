...
\begin{align*}
    \prob\pars{\sum_{t \in R} Z_t < \gamma_{i+1} \mid \mathcal{F}_i } &\leq \prob\pars{\Bin\pars{\frac{n}{2^{i+1}}, p_i} < \gamma_{i+1}} \\
...
\]
Pozostało teraz tylko dowieźć \(\pars{1 - \frac{1}{n^2}}^{i^*} \geq 1 - \frac{1}{n}\) dla odpowiednio dużego \(n\), z czego będziemy już mieli \(\prob\pars{\mathcal{F}_{i^*}} \geq 1 - \frac{1}{n}\), a więc z wysokim prawdopodobieństwem istnieje urna z przynajmniej \(i^*\) kulami, co kończy dowód. Przejdźmy więc do tej ostatniej części
\[
