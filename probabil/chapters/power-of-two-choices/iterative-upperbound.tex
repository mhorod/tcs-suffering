...
Możemy zauważyć, że to co pokazaliśmy z indukcji jest prawdziwe jedynie dla \( i \leq i^* \), zatem \( \prob\pars{\neg\mathcal{E}_{i^*}} \leq \frac{i^*}{n^{\alpha}} \)
...
\begin{align*}
	...
	&\leq \frac{\pars{9\alpha\ln n}^4}{n^{2\beta -2}\prob\pars{\nu_{i^* + 1}(n) \leq 9\alpha\ln n}}
\end{align*}
...
\begin{align*}
	...
	&\leq \prob\pars{\mu_{i^* + 2}(n) \geq 2\alpha \mid \nu_{i^* + 1}(n) < 9\alpha\ln n}\prob\pars{\nu_{i^* + 1}(n) < 9\alpha\ln n} + \prob\pars{\nu_{i^* + 1}(n) < 9\alpha\ln n} \\
	&\leq \frac{\pars{9\alpha\ln n}^4}{n^{2*2\alpha - 2}} + \frac{i^* + 1}{n^{\alpha}} \\
	&< \frac{1}{n^{\alpha - 1}}
\end{align*}
