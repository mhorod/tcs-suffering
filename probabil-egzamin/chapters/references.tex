...
\section{Równość funkcji tworzących}
{
	\ExecuteMetaData[chapters/discrete-probability/moment-generating-functions]{probabil-egzamin-generating-function-equality}
}

\section{Ograniczenie górne Czernowa prób Poissona}
{
	\ExecuteMetaData[chapters/inequalities/chernoff]{probabil-egzamin-chernoff-lowerbound}
}
}
