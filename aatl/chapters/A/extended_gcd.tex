...
\begin{proof}
	Wystarczy pokazać, że \( \gcd(a, b) = \gcd(b, r) \), jeśli \( a = q \cdot b + r \).
	\[
		a = b = 0 \pmod{\gcd(a, b)}
	\]
	\[
		r = a - q \cdot b = 0 \pmod{\gcd(a, b)} \implies \gcd(a, b) \mid \gcd(b, r)
	\]
	\[
		b = r = 0 \pmod{\gcd(b, r)}
	\]
	\[
		a = q \cdot b + r = 0 \pmod{\gcd(b, r)} \implies \gcd(b, r) \mid \gcd(a, b)
	\]
\end{proof}
