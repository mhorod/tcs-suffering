...
\begin{proof}
	...
	Jeśli obie liczby są nieparzyste, to obliczamy \( \gcd(a, b) = \gcd(b, a - b) \), ponieważ:
	\[
		a = b = 0 \pmod{\gcd(a, b)}
	\]
	\[
		a - b = 0 \pmod{\gcd(a, b)} \implies \gcd(a, b) \mid \gcd(b, a - b)
	\]
	\[
		b = a - b = 0 \pmod{\gcd(b, a - b)}
	\]
	\[
		a = (a - b) + b = 0 \pmod{\gcd(b, a - b)} \implies \gcd(b, a - b) \mid \gcd(a, b)
	\]
\end{proof}
