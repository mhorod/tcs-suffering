...
\textbf{Faza III:} \\
Żeby znaleźć \( \log b \), próbujemy wygenerować jakąkolwiek liczbę postaci \( b^u \cdot g^v \), która jest rozkładalna na czynniki pierwsze z \(Q\) (tzw. gładka). Wystarczy przyjąć \( u = 1 \) i losować \( v \) do skutku. Z równości
