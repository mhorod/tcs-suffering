...
\begin{proof}
	...
	Załóżmy nie wprost, że \( \mathbb{Z}_p[X]/W \) jest ciałem i \( W \) jest rozkładalny, czyli można zapisać \linebreak \( W = g_1 \cdot g_2 \), gdzie \( 1 \lleq \deg(g_1), \deg(g_2) < \deg(W) \).
